            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form novalidate method="POST" action=" {{Route('userproducts.update',$data->id) }} " enctype="multipart/form-data" > <!--form-->
                        @csrf  
                         <div class="row">
                           <div class="col-12">	
                            ...
                            <div class="row">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" hidden name="Product_username" value= {{ $userData->name }}  class="form-control"  required="" aria-invalid="false"> 
                                        </div>
                                    </div>
