            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form novalidate method="POST" action=" {{Route('buyerdetails.update',$editinvoiceData->id) }} " enctype="multipart/form-data" > <!--form-->
                        @csrf  
                         <div class="row">
                           <div class="col-12">	
                         ...
                         <!--Sub machine selection end here-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="payment_link"  value="{{ $editinvoiceData->payment_link }}" class="form-control"   aria-invalid="false"> </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        <h5>Invoice Status <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <select name="invoice_status" id="invoice_status" required  class="form-control">
                                                ...
                                                <option value="active" {{ $editinvoiceData->invoice_status =="active"?"selected":""  }} >Active</option>
                                                <option value="inactive" {{ $editinvoiceData->invoice_status =="inactive"?"selected":""  }}>Inactive</option>
