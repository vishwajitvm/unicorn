    ...
    <div class="container-full">
      ...
      <div class="content-header">
          <div class="d-flex align-items-center">
              <div class="mr-auto">
                  <h3 class="page-title">View All Assigned Product To Users</h3>
                  <div class="d-inline-block align-items-center">
                      <nav>
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                              <li class="breadcrumb-item" aria-current="page">Tables</li>
                              <li class="breadcrumb-item active" aria-current="page"> Assign Products </li>
                          </ol>
                      </nav>
                  </div>
              </div>
                      ...
                      <tbody>
                        @foreach ($userData as $key => $row)
                          <tr>
                              ...
                              <td>
                                <!--button here-->
                                <a class="btn btn-info btn-block" href=" {{Route('assignproduct.requestview',$row->id)}} ">View all Request</a>
                                {{-- &nbsp;&nbsp;
